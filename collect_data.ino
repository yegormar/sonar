// Data Collection Script - Use ORIGINAL v1 for consistent baseline
// Collects raw sensor data for Python modeling
// DO NOT MODIFY - This ensures consistent data format
...
void setup() {
  ...
  Serial.println(F("=== DATA COLLECTION MODE ==="));
  Serial.println(F("ts(ms),L(cm),R(cm),diff,side,leds"));
}
...
void loop() {
  ...
  // Always print for data collection
  Serial.print(millis());
  Serial.print(F(","));
  Serial.print(L, 1);
  Serial.print(F(","));
